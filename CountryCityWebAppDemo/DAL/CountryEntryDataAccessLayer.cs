...
namespace CountryCityWebAppDemo.DAL
{
    public class CountryEntryDataAccessLayer
    {
        ...
        {
            String query = string.Format("Insert into tblCountry values('{0}','{1}')",aCountry.Name,aCountry.About);
            sqlCommand.CommandText = query; 
            
            // SqlParameter nameParameter = new SqlParameter("@Name",aCountry.Name);
            //sqlCommand.Parameters.Add(nameParameter);

            //SqlParameter aboutParameter = new SqlParameter("@About",aCountry.About);
