...
namespace CountryCityWebAppDemo.UI
{
    public partial class ViewCity : System.Web.UI.Page
    {
        ...
        protected void citySearchGridView_PageIndexChanging(object sender, GridViewPageEventArgs e)
        {
            citySearchGridView.PageIndex = e.NewPageIndex;
            GetAllCityInformationInGridVew();
        }

        protected void citySearchGridView_RowDataBound(object sender, GridViewRowEventArgs e)
        {
